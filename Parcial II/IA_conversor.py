...
conversor = pd.read_csv("C:\\Users\\wmedr\\Downloads\\Parcial II\Parcial II\\conversor.csv",sep=";")

"C:\\Users\\50369\\Desktop\Parcial II\\conversor.csv"
print (conversor["farenheit "])


# datos de entrada y salida
farenheit = conversor["farenheit "]
celsius = conversor["celsius"]
...
#entrenar el modelo
epocas = modelo.fit(farenheit,celsius , epochs=250, verbose=1)

# hacer prediciones .. verificar si el resultado es el esperado
predicc = modelo.predict([-30])
print("Prediccion farenheit a celsius", predicc[0][0])
...
#6. Iniciamos el server en el puerto 3002
print("Iniciando el server en el puerto 3002")
servidor = HTTPServer(("localhost", 3002), servidorBasico)
